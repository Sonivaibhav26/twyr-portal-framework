/*
 * Name			: portal_modules/services/auth-service/strategies/persist-user.js
 * Author		: Vish Desai (vishwakarma_d@hotmail.com)
 * Version		: 0.6.1
 * Copyright	: Copyright (c) 2014 Vish Desai (https://www.linkedin.com/in/vishdesai).
 * License		: The MIT License (http://opensource.org/licenses/MIT).
 * Description	: The Twy'r Portal Authentication Service Social Login Persistence Mechanism
 *
 */
	...
	.then(function(userSocialRecord) {
		if(userSocialRecord) {
			...
			.then(function(userSocialLoginRecord) {
				if(newSocialUser) {
					self.$dependencies.eventService.emit('socialregistration', userSocialLoginRecord.get('user_id'), request.query.state);
				}
